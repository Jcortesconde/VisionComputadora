...
fprintf('\ta.\n');
fprintf('\t\tsigma 1.\n');
[a, b,c,d] = punto3(uint8(lena_ruido_gauss1*255), uint8(test_ruido_gauss1*255), mascara);
pause;
close all;
fprintf('\t\tsigma 0.5.\n');
[a, b,c,d] = punto3(uint8(lena_ruido_gauss2*255), uint8(test_ruido_gauss2*255), mascara);
pause;
close all;
fprintf('\t\tsigma 0.01.\n');
[a, b,c,d] = punto3(uint8(lena_ruido_gauss3*255), uint8(test_ruido_gauss3*255), mascara);
pause;
close all;
fprintf('\tb.\n');
